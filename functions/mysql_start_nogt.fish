                        ...
                        case 1
                                ...
                                if not test -d $DATADIR
                                        ...
                                        case '*-5.6*'
                                                ...
                                                eval $MYSQL_ROOT_FOLDER/bin/mysqld --no-defaults --basedir=$BASEDIR --datadir=$DATADIR -P 1300$ID --socket=$SOCKET --server-id=$ID --log-bin=bin-log --log-slave-updates --report-host=localhost --master-info-repository=TABLE
                                        case '*-5.7*'
